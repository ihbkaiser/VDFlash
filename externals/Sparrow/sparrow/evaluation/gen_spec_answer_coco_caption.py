...
def load_data(args):
    dataset = load_dataset("HuggingFaceM4/COCO", split="test" , cache_dir = "/root/autodl-tmp/datasets" )
...
def get_model_answers(
    ...
    for _ in range(3):
        ...
        output_ids, new_token, idx = model.specgenerate(
            # output_ids, new_token, idx, flops, flops_ori = model.specgenerate(
            **model_inputs,
    ...
    for d in tqdm(data):
        ...
        for i in range(num_choices):
            ...
            output_ids, new_token, idx, accp_len = model.specgenerate(
                # output_ids, new_token, idx, flops, flops_ori, accp_len = model.specgenerate(
                **model_inputs,
                temperature=temperature,
                log=True,
...
if __name__ == "__main__":
    ...
    if args.hf_home is not None:
        os.symlink(args.hf_home, "/cache/.hf_cache")
