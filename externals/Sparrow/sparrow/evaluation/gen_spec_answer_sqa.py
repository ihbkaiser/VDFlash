...
def load_data(args):
    ...
    # data = load_dataset("derek-thomas/ScienceQA", cache_dir = "/root/autodl-tmp/datasets" )
    # data = load_dataset("/root/autodl-tmp/datasets/ScienceQA" )
    data = load_dataset("/root/autodl-tmp/datasets/ScienceQA" )
    ...
    for split_name, qids in pid_splits.items():
        ...
        for i, qid in enumerate(qids):
            # print("split[i][=image]",split[i]["image"])
...
def get_model_answers(
    ...
    elif args.use_msd_jianzhi:
        print("msdmsdmsdmsd_jianzhi")
        from ..model.spec_model_msd_jianzhi import SpecModel
...
if __name__ == "__main__":
    ...
    parser.add_argument("--data_root", type=str, default="/root/autodl-tmp/ScienceQA-main/data/scienceqa")
    # parser.add_argument("--output_root", type=str, default="../results")
    parser.add_argument(
        "--caption_file", type=str, default="/root/autodl-tmp/ScienceQA-main/data/captions.json"
    )
    ...
    parser.add_argument("--use_msd", type=bool, default=False)
    parser.add_argument("--use_msd_jianzhi", type=bool, default=False)
