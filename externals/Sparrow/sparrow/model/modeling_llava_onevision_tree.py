...
from .modeling_qwen2_tree import Qwen2ForCausalLM
...
class LlavaOnevisionCausalLMOutputWithPast(ModelOutput):
    ...
    output_embeddings: Optional[torch.FloatTensor] = None #MODIFIED
...
class LlavaOnevisionForConditionalGeneration(LlavaOnevisionPreTrainedModel, GenerationMixin):
    ...
    def forward(
        ...
        selected_indices: Optional[torch.LongTensor] = None, #MODIFIED
        idx_layer = None ,
        ...
        if pixel_values_videos is not None:
            print("11111111111112333333333333111111111")
        ...
        return LlavaOnevisionCausalLMOutputWithPast(
            ...
            output_embeddings=inputs_embeds,#MODIFIED
        )
