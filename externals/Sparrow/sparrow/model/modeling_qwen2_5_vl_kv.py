    ...
    def forward(
        ...
        for layer_num, blk in enumerate(self.blocks):
            ...
            if self.gradient_checkpointing and self.training:
                ...
                # print("cu_seqlens_now",cu_seqlens_now.shape)
                # print("cu_seqlens_now",cu_seqlens_now.dtype)
                # print("position_embeddings",position_embeddings.shape)
                # print("position_embeddings",position_embeddings.dtype)
                # if isinstance(position_embeddings, tuple):
                #     for i, t in enumerate(position_embeddings):
                #         print(f"position_embeddings[{i}]  shape={t.shape}  dtype={t.dtype}")
                # else:
...
class Qwen2_5_VLForConditionalGeneration(Qwen2_5_VLPreTrainedModel, GenerationMixin):
    ...
    def __init__(self, config):
        # config.max_position_embeddings = 10000 #4096  # [MODIFIED]
        super().__init__(config)
