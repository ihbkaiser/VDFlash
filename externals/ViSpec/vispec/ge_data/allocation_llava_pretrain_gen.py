...
outdir = "{}/llava_pretrain_gen_{}_{}_mufp16".format(args.outdir, s, e)
...
for i in range(num_p):
    ...
    # )
    command = "{} -m vispec.ge_data.ge_data_all_llava_pretrain_gen --start={} --end={} --index={} --gpu_index {} --outdir {} --model {} --temperature {}".format(
        sys.executable,
        start,
        end,
        index,
