...
def load_data(args):
    ...
    # data = load_dataset("derek-thomas/ScienceQA", cache_dir = "/root/autodl-tmp/datasets/ScienceQA" )
    data = load_dataset("/root/autodl-tmp/datasets/ScienceQA" )
#     data_dir = "/root/autodl-tmp/datasets/ScienceQA/data" 
#     data = load_dataset(
#     "parquet",  # 明确数据格式为parquet
#     data_files={
