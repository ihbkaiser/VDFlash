...
def add_pipeline_arguments(parser: argparse.ArgumentParser) -> None:
    ...
    parser.add_argument("--teacher-length-bucket-size", type=int, default=None)
    parser.add_argument("--teacher-preprocess-workers", type=int, default=None)
    parser.add_argument("--teacher-write-queue-depth", type=int, default=None)
